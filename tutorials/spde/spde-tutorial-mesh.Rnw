...
Figure~\ref{fig:ncmesh} by commands bellow 
<<ncmeshv,eval=F>>=
...
\setkeys{Gin}{width=0.99\textwidth}
\begin{figure}\centering
<<vncmeshv,echo=F,results=hide,fig=TRUE,eps=FALSE,width=5.5,height=5.5>>=
<<ncmeshv>>
@ 
...
mesh2 <- inla.mesh.2d(coords, max.edge=c(0.1, 0.2)) 
@ 
...
<<mesh3>>=
mesh3 <- inla.mesh.2d(coords, max.edge=c(0.1, 0.2), cutoff=0.03)
@ 
...
previous 
<<mesh456>>=
mesh4 <- inla.mesh.2d(, pl.dom, max.e=c(0.04, 0.1), cutoff=0.015)
mesh5 <- inla.mesh.2d(, pl.dom, max.e=c(0.08, 0.2), cutoff=0.025)
mesh6 <- inla.mesh.2d(, pl.dom, max.e=c(0.10, 0.2), cutoff=0.045)
@ 
...
\setkeys{Gin}{width=0.99\textwidth}
\begin{figure}\centering
<<vprmeshecho=F,results=hide,fig=TRUE,eps=FALSE,width=7.5,height=3.5>>=
<<prmesh>>
@ 
