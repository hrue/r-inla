...
The R source code for this example is available at
\url{http://www.math.ntnu.no/inla/r-inla.org/tutorials/spde/R/spde-tutorial-coregionalization.R}
...
mesh will makes the projector sparser.
