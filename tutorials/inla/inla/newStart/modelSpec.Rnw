...
result = inla(#formula for the linear predictor
    ...
    # dataset
    data,
    # more optional entries secifying the prior for the fixed effects,
    control.fixed,
    # or hyerpriors for hyperparameters in the likelihood function,
    control.family,
    # a vector of quantiles that should be computed for each posterior marginal
    quantiles,
    # whether model choice criteria chould be computed
    control.compute,
    # whether marginals for the linear predictior should be computed
    control.predictor,
