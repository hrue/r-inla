...
scotland.inla.fit.3 = inla(Counts ~ 1 + f(Region, model="iid", param=c(1, .0014)) +
    f(Region2, model="besag", graph.file="scotland.graph", param=c(1, .2/.59)), data=Scotland, family="poisson", E=E )
...
scotland.inla.fit.4 = inla(Counts ~ 1 + I(X/10) + f(Region, model="iid", param=c(1, .0014)) +
    f(Region2, model="besag", graph.file="scotland.graph", param=c(1, .4/.59)), data=Scotland, family="poisson", E=E )
