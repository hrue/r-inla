...
\begin{figure}[tbp]\centering\includegraphics[width=7cm,height=7cm,angle=-90]{Sweave/ex1/figure-190}
\includegraphics[width=7cm,height=7cm,angle=-90]{Sweave/ex1/figure-191}
\includegraphics[width=7cm,height=7cm,angle=-90]{Sweave/ex1/figure-192}\caption{The posterior marginals for the fixed effects for the intercept and covariate 	v{x}, and the precision for the Gaussian observations.}\label{fig:11}\end{figure}%%
...
\end{Sinput}
\end{Schunk}
\includegraphics{Sweave/sweave-023}
%%
\end{center}
...
\end{Sinput}
\end{Schunk}
\includegraphics{Sweave/sweave-024}
%%
\end{center}
...
\begin{Soutput}
List of 1
 $ Precision for the Gaussian observations: num [1:109, 1:2] 0.00352 0.00474 0.0065 0.00879 0.0117 ...
  ..- attr(*, "dimnames")=List of 2
  .. ..$ : NULL
  .. ..$ : chr [1:2] "x" "y"
\end{Soutput}
...
\end{Sinput}
\end{Schunk}
\includegraphics{Sweave/sweave-030}
%%
