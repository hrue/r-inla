...
\begin{figure}[tbp]\centering\includegraphics[width=7cm,height=7cm,angle=-90]{Sweave/ex1/figure-148}
\includegraphics[width=7cm,height=7cm,angle=-90]{Sweave/ex1/figure-149}
\includegraphics[width=7cm,height=7cm,angle=-90]{Sweave/ex1/figure-150}\caption{The posterior marginals for the fixed effects for the intercept and covariate 	v{x}, and the precision for the Gaussian observations.}\label{fig:11}\end{figure}
