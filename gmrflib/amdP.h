...
//
	...
	UF_long amd_l_order				       /* see above for description of arguments */
	 (UF_long n, const UF_long Ap[], const UF_long Ai[], UF_long P[], double Control[], double Info[]
	    );
 ...
 * description of each parameter. */
	...
	void amd_2
	    (int n,
	     ...
	     int Iw[],
	     int Len[],
	     int iwlen, int pfree, int Nv[], int Next[], int Last[], int Head[], int Elen[], int Degree[], int W[], double Control[], double Info[]
	    );
	...
	void amd_l2
	    (UF_long n,
	     ...
	     UF_long pfree,
	     UF_long Nv[],
	     UF_long Next[], UF_long Last[], UF_long Head[], UF_long Elen[], UF_long Degree[], UF_long W[], double Control[], double Info[]
	    );
