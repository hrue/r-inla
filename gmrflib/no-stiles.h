...
int sTiles_solve_LLT(int group_index, int call_index, void **obj, double *B, int sindex);
int sTiles_solve_L(int group_index, int call_index, void **obj, double *B, int sindex);
int sTiles_solve_LT(int group_index, int call_index, void **obj, double *B, int sindex);
