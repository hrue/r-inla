			       ...
			       double *x_vec, GMRFLib_logl_tp *loglFunc, void *loglFunc_arg, double *step_len, int *stencil)
{
	...
	if (step_len && *step_len < 0.0) {
		...
		static double wf5[] = {
			// 
			0.08333333333333333, -0.6666666666666666, 0.0, 0.6666666666666666, -0.08333333333333333, 0, 0, 0, 
			// 
			-0.08333333333333333, 1.333333333333333, -2.5, 1.333333333333333, -0.08333333333333333, 0, 0, 0, 
			// 
			-0.5, 1.0, 0.0, -1.0, 0.5,  0, 0, 0
		};

		static double wf7[] = {
			// 
			-0.01666666666666667, 0.15, -0.75, 0.0, 0.75, -0.15, 0.01666666666666667, 0, 
			// 
			0.01111111111111111, -0.15, 1.5, -2.722222222222222, 1.5, -0.15, 0.01111111111111111, 0, 
			// 
			0.125, -1.0, 1.625, 0.0, -1.625, 1.0, -0.125, 0
		};

		static double wf9[] = {
			// 
			0.003571428571428571, -0.0380952380952381, 0.2, -0.8, 0.0, 0.8, -0.2, 0.0380952380952381, -0.003571428571428571, 0, 0, 0, 0, 0, 0, 0, 
			// 
			-0.001785714285714286, 0.0253968253968254, -0.2, 1.6, -2.847222222222222, 1.6, -0.2, 0.0253968253968254, 
			-0.001785714285714286, 0, 0, 0, 0, 0, 0, 0, 
			// 
			-0.02916666666666667, 0.3, -1.408333333333333, 2.033333333333333, 0.0, -2.033333333333333, 1.408333333333333, -0.3,
			0.02916666666666667, 0, 0, 0, 0, 0, 0, 0
		};
