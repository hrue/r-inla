...
// THIS IS ONLY CALLED FOR n=16
{
	simde__m128d vx0 = simde_mm_loadu_pd(&x[0]);
	simde__m128d vx1 = simde_mm_loadu_pd(&x[2]);
	simde__m128d vx2 = simde_mm_loadu_pd(&x[4]);
	simde__m128d vx3 = simde_mm_loadu_pd(&x[6]);
	simde__m128d vx4 = simde_mm_loadu_pd(&x[8]);
	simde__m128d vx5 = simde_mm_loadu_pd(&x[10]);
	simde__m128d vx6 = simde_mm_loadu_pd(&x[12]);
	simde__m128d vx7 = simde_mm_loadu_pd(&x[14]);

	simde__m128d sum_xy = simde_mm_setzero_pd();
	...
	simde__m128d sum_xz = simde_mm_setzero_pd();
