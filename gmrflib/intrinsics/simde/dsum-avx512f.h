{
	if (n >= 32) {
		...
		__m512d final_sum = simde_mm512_add_pd(simde_mm512_add_pd(s0, s1), 
						  simde_mm512_add_pd(s2, s3));
		__m256d low256 = simde_mm256_castpd512_pd256(final_sum);
		__m256d high256 = simde_mm256_extractf128_pd(final_sum, 1); 
		__m256d sum256 = simde_mm256_add_pd(low256, simde_mm256_extractf128_pd(simde_mm256_castpd512_pd256(simde_mm512_alignr_epi64(final_sum, final_sum, 32)), 1));
		double temp[8];
