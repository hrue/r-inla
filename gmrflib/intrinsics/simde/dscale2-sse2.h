{
	simde__m128d va = simde_mm_set1_pd(a);
	int i = 0;
	for (; i <= n - 16; i += 16) {
		simde__m128d x0 = simde_mm_loadu_pd(&x[i]);
		simde__m128d x1 = simde_mm_loadu_pd(&x[i + 2]);
		simde__m128d x2 = simde_mm_loadu_pd(&x[i + 4]);
		simde__m128d x3 = simde_mm_loadu_pd(&x[i + 6]);
		simde__m128d x4 = simde_mm_loadu_pd(&x[i + 8]);
		simde__m128d x5 = simde_mm_loadu_pd(&x[i + 10]);
		simde__m128d x6 = simde_mm_loadu_pd(&x[i + 12]);
		simde__m128d x7 = simde_mm_loadu_pd(&x[i + 14]);
