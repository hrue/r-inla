...
*/
#define GMRFLib_ENTER_ROUTINE GMRFLib_DEBUG_INIT; GMRFLib_DEBUG_d("Enter", GMRFLib_cpu()); if (GMRFLib_collect_timer_statistics) GMRFLib_timer_enter(GMRFLib_timer_strip(__GMRFLib_FuncName))
