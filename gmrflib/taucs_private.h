...
int taucs_ccs_solve_schur(taucs_ccs_matrix * L,
			  ...
			  int (*schur_precond_fn)(void *, void *x, void *b), void *schur_precond_args, int maxits, double convratio, void *x,
			  void *b);
int taucs_dtl(ccs_solve_schur) (taucs_ccs_matrix * L, taucs_ccs_matrix * schur_comp,
				int (*schur_precond_fn) (void *, taucs_datatype * x, taucs_datatype * b), void *schur_precond_args, int maxits,
				double convratio, taucs_datatype * x, taucs_datatype * b);
