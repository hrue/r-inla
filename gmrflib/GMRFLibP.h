 ...
 *
 * RCSId: $Id: GMRFLibP.h,v 1.64 2010/02/18 13:44:43 hrue Exp $
 *
 */
...
#define GMRFLib_GLOBAL_NODE(n) ((int) IMIN((n-1)*GMRFLib_global_node_factor, GMRFLib_global_node_degree))
