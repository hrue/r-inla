			...
			GMRFLib_ai_param_tp * UNUSED(ai_par))
{
	 ...
	 *
	 *
	 * About the interaction terms: The ff_Qfunc is a 2d array [0...nf-1] x [0...nf-1] of interaction functions, which adds interaction terms between f[i][k]
...
int GMRFLib_preopt_free(GMRFLib_hgmrfm_tp * hgmrfm)
{
	if (!hgmrfm) {
		return GMRFLib_SUCCESS;
	}
