...
void apply_transform_vectorized(int transform, double *RESTRICT dij, int nb);
void build_theta_vector(double *RESTRICT theta, int nc, double ***model_theta, int thread_id);
void compute_d_values_opt(double *RESTRICT d, double *RESTRICT vals, double *RESTRICT theta, int nc);
void compute_diagonal_values(double *RESTRICT dij, double *RESTRICT v, double *RESTRICT values, int nb);
void perform_matrix_vector_mult(double *RESTRICT V, double *RESTRICT theta, double *RESTRICT dij, int nc, int n);
