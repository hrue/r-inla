...
double inla_spde_Qfunction(int thread_id, int node, int nnode, double *values, void *arg);
double *inla_spde_userfunc0(int thread_id, GMRFLib_problem_tp * problem, double *theta, int nhyper);
double *inla_spde_userfunc1(int thread_id, double *theta, int nhyper, double *covmat);
