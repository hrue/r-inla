...
/*
void expansion_print(int elen, CREAL *e)
{
  int i;
...
int grow_expansion(int elen, CREAL *e, REAL b,
...
int grow_expansion_zeroelim(int elen, CREAL *e, REAL b,
                            REAL *h) /* e and h can be the same. */
{
  REAL Q, hh;
  INEXACT REAL Qnew;
...
int expansion_sum(int elen, CREAL *e, int flen, CREAL *f, REAL *h)
...
int expansion_sum_zeroelim1(int elen, CREAL *e, int flen, CREAL *f, REAL *h)
/* e and h can be the same, but f and h cannot. */
{
  REAL Q;
  INEXACT REAL Qnew;
...
int expansion_sum_zeroelim2(int elen, CREAL *e, int flen, CREAL *f, REAL *h)
/* e and h can be the same, but f and h cannot. */
{
  REAL Q, hh;
  INEXACT REAL Qnew;
...
int fast_expansion_sum(int elen, CREAL *e, int flen, CREAL *f,
...
int fast_expansion_sum_zeroelim(int elen, CREAL *e, int flen, CREAL *f,
                                REAL *h) /* h cannot be e or f. */
{
  REAL Q;
  INEXACT REAL Qnew;
...
int linear_expansion_sum(int elen, CREAL *e, int flen, CREAL *f,
                         REAL *h) /* h cannot be e or f. */
{
  REAL Q, q;
  INEXACT REAL Qnew;
...
int linear_expansion_sum_zeroelim(int elen, CREAL *e, int flen, CREAL *f,
                                  REAL *h) /* h cannot be e or f. */
{
  REAL Q, q, hh;
  INEXACT REAL Qnew;
...
int scale_expansion(int elen, CREAL *e, REAL b,
...
int scale_expansion_zeroelim(int elen, CREAL *e, REAL b,
                             REAL *h) /* e and h cannot be the same. */
{
  INEXACT REAL Q, sum;
  REAL hh;
...
int compress(int elen, CREAL *e, REAL *h) /* e and h may be the same. */
{
  REAL Q, q;
  INEXACT REAL Qnew;
  int eindex, hindex;
...
REAL estimate(int elen, CREAL *e) {
  REAL Q;
  int eindex;
...
REAL orient2dexact(CREAL *pa, CREAL *pb, CREAL *pc) {
...
REAL orient2dslow(CREAL *pa, CREAL *pb, CREAL *pc) {
...
REAL orient2dadapt(CREAL *pa, CREAL *pb, CREAL *pc, REAL detsum) {
  INEXACT REAL acx, acy, bcx, bcy;
...
REAL orient3dexact(CREAL *pa, CREAL *pb, CREAL *pc, CREAL *pd) {
...
REAL orient3dslow(CREAL *pa, CREAL *pb, CREAL *pc, CREAL *pd) {
...
REAL orient3dadapt(CREAL *pa, CREAL *pb, CREAL *pc, CREAL *pd, REAL permanent) {
...
REAL incircleexact(CREAL *pa, CREAL *pb, CREAL *pc, CREAL *pd) {
  INEXACT REAL axby1, bxcy1, cxdy1, dxay1, axcy1, bxdy1;
  INEXACT REAL bxay1, cxby1, dxcy1, axdy1, cxay1, dxby1;
  REAL axby0, bxcy0, cxdy0, dxay0, axcy0, bxdy0;
  REAL bxay0, cxby0, dxcy0, axdy0, cxay0, dxby0;
...
REAL incircleslow(CREAL *pa, CREAL *pb, CREAL *pc, CREAL *pd) {
...
REAL incircleadapt(CREAL *pa, CREAL *pb, CREAL *pc, CREAL *pd, REAL permanent) {
  INEXACT REAL adx, bdx, cdx, ady, bdy, cdy;
  REAL det, errbound;
...
REAL insphereexact(CREAL *pa, CREAL *pb, CREAL *pc, CREAL *pd, CREAL *pe) {
...
REAL insphereslow(CREAL *pa, CREAL *pb, CREAL *pc, CREAL *pd, CREAL *pe) {
...
REAL insphereadapt(CREAL *pa, CREAL *pb, CREAL *pc, CREAL *pd, CREAL *pe,
                   REAL permanent) {
  INEXACT REAL aex, bex, cex, dex, aey, bey, cey, dey, aez, bez, cez, dez;
  REAL det, errbound;
...
class exactinit_t {
public:
  exactinit_t(void) { exactinit(); };
};

exactinit_t exactinit_init();
