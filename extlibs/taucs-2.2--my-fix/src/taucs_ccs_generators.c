...
taucs_ccs_matrix *taucs_ccs_generate_mesh2d(int n, char *which)
{
	...
	/*
	 * for (j=0; j<N; j++) { for (ip=(m->colptr)[j]; ip < (m->colptr)[j+1]; ip++) { i = (m->rowind)[ip]; taucs_printf("<%d %d
...
int recursive_visit(int i, int *neighbors[], int degree[], int visited[])
{
	int j, jp, count;
	...
	for (z = 0; z < Z; z++) {
		for (y = 0; y < Y; y++) {
			for (x = 0; x < X; x++) {
				...
				(m->rowind)[ip] = j;
				/*
				 * if (x==0 && y==0 && z==0) (m->taucs_values)[ip]= 1.0; else 
				 */
	...
	for (z = 0; z < Z; z++) {
		for (y = 0; y < Y; y++) {
			for (x = 0; x < X; x++) {
				 ...
				 */
				/*
				 * (m->taucs_values)[ip] = D[j]; if (x==0 || x==X-1) (m->taucs_values)[ip] += 1.0; if (y==0 ||
				 * y==Y-1) (m->taucs_values)[ip] += 1.0; if (z==0 || z==Z-1) (m->taucs_values)[ip] += 1.0; 
				 */
				...
				cj = ((x) >= X / 8 && (x) < 7 * X / 8)
				    ...
				    && ((z) >= Z / 8 && (z) < 7 * Z / 8);
				/*
				 * cj = cj && !( ((x ) >= 2*X/8 && (x ) < 6*X/8) && ((y ) >= 2*Y/8 && (y ) < 6*Y/8) && ((z ) >=
				 * 2*Z/8 && (z ) < 6*Z/8)); 
				 */
				cjw = ((x - 1) >= X / 8 && (x - 1) < 7 * X / 8)
				    ...
				    && ((z) >= Z / 8 && (z) < 7 * Z / 8);
				/*
				 * cjw = cjw && !( ((x-1) >= 2*X/8 && (x-1) < 6*X/8) && ((y ) >= 2*Y/8 && (y ) < 6*Y/8) && ((z )
				 * >= 2*Z/8 && (z ) < 6*Z/8)); 
				 */
				cje = ((x + 1) >= X / 8 && (x + 1) < 7 * X / 8)
				    ...
				    && ((z) >= Z / 8 && (z) < 7 * Z / 8);
				/*
				 * cje = cje && !( ((x+1) >= 2*X/8 && (x+1) < 6*X/8) && ((y ) >= 2*Y/8 && (y ) < 6*Y/8) && ((z )
				 * >= 2*Z/8 && (z ) < 6*Z/8)); 
				 */
				cjs = ((x) >= X / 8 && (x) < 7 * X / 8)
				    && ((y - 1) >= Y / 8 && (y - 1) < 7 * Y / 8)
				    && ((z) >= Z / 8 && (z) < 7 * Z / 8);
				/*
				 * cjs = cjs && !( ((x ) >= 2*X/8 && (x ) < 6*X/8) && ((y-1) >= 2*Y/8 && (y-1) < 6*Y/8) && ((z )
				 * >= 2*Z/8 && (z ) < 6*Z/8)); 
				 */
				cjn = ((x) >= X / 8 && (x) < 7 * X / 8)
				    && ((y + 1) >= Y / 8 && (y + 1) < 7 * Y / 8)
				    && ((z) >= Z / 8 && (z) < 7 * Z / 8);
				/*
				 * cjn = cjn && !( ((x ) >= 2*X/8 && (x ) < 6*X/8) && ((y+1) >= 2*Y/8 && (y+1) < 6*Y/8) && ((z )
				 * >= 2*Z/8 && (z ) < 6*Z/8)); 
				 */
				cjd = ((x) >= X / 8 && (x) < 7 * X / 8)
				    && ((y) >= Y / 8 && (y) < 7 * Y / 8)
				    && ((z - 1) >= Z / 8 && (z - 1) < 7 * Z / 8);
				/*
				 * cjd = cjd && !( ((x ) >= 2*X/8 && (x ) < 6*X/8) && ((y ) >= 2*Y/8 && (y ) < 6*Y/8) && ((z-1) >= 
				 * 2*Z/8 && (z-1) < 6*Z/8)); 
				 */
				cju = ((x) >= X / 8 && (x) < 7 * X / 8)
				    && ((y) >= Y / 8 && (y) < 7 * Y / 8)
				    && ((z + 1) >= Z / 8 && (z + 1) < 7 * Z / 8);
				/*
				 * cju = cju && !( ((x ) >= 2*X/8 && (x ) < 6*X/8) && ((y ) >= 2*Y/8 && (y ) < 6*Y/8) && ((z+1) >= 
				 * 2*Z/8 && (z+1) < 6*Z/8)); 
				 */
