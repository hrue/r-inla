...
taucs_dtl(ccs_solve_schur) (taucs_ccs_matrix * L,
	...
	/*
	 * now y_1 is computed, L_11 y_1 = b_1, x_2 holds (b_2 - L_21 y_1). move y_2 <- x_2. 
	 */
	...
	assert(0);
#if 0
	taucs_conjugate_gradients(schur_comp, schur_precond_fn, schur_precond_args, x + p,	/* this is x_2 */
				  y + p,		       /* this is y_2 */
				  maxits,		       /* itermax */
