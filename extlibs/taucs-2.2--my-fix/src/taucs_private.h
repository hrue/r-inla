...
taucs_datatype taucs_dtl(complex_create_fn) (taucs_real_datatype re, taucs_real_datatype im);
#endif
...
int taucs_conjugate_gradients(taucs_ccs_matrix * A,
			      ...
			      void *precond_args, void *X, void *B, int itermax, double convergetol);
...
taucs_ccs_matrix *taucs_amwb_preconditioner_create(taucs_ccs_matrix * symccs_mtxA, int rnd, double subgraphs, int stretch_flag);
...
void taucs_vec_axpby(int n, int flags, taucs_double a, void *x, taucs_double b, void *y, void *axpby);
