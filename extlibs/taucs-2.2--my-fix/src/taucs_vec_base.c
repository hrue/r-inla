...
void taucs_vec_axpby(int n, int flags, taucs_double a, void *x, taucs_double b, void *y, void *axpby)
{
	...
	if (flags & TAUCS_DOUBLE)
		taucs_dvec_axpby(n,
				 ...
				 (taucs_double) b, (taucs_double *) y, (taucs_double *) axpby);
#endif
	...
	if (flags & TAUCS_SINGLE)
		taucs_svec_axpby(n,
				 ...
				 (taucs_single) b, (taucs_single *) y, (taucs_single *) axpby);
#endif
	...
	if (flags & TAUCS_DCOMPLEX)
		taucs_zvec_axpby(n,
				 ...
				 (taucs_double) b, (taucs_dcomplex *) y, (taucs_dcomplex *) axpby);
#endif
	...
	if (flags & TAUCS_SCOMPLEX)
		taucs_cvec_axpby(n,
				 ...
				 (taucs_single) b, (taucs_scomplex *) y, (taucs_scomplex *) axpby);
#endif
}
