                ...
                iidkd = list(
                    ...
                    hyper = list(
                        theta1 = list(
                            ...
                            fixed = FALSE,
                            prior = "wishartkd",
                            param = c(21, rep(inla.special.number(), (20*21)/2)), 
                            to.theta = function(x) x,
                            from.theta = function(x) x
                        ),
                        theta2 = list(
                    ...
                    augmented = TRUE,
                    aug.factor = 1L,
                    aug.constr = c(1L, 2L, 3L, 4L, 5L, 6L, 7L, 8L, 9L, 10L, 11L, 12L, 13L, 14L, 15L, 16L, 17L, 18L, 19L, 20L),
                    n.div.by = -1,
                    n.required = TRUE,
                    set.default.values = TRUE,
                    status = "experimental", 
        ...
        likelihood =
            list(
                ...
                "0poisson" = list(
                    ...
                    link.simple = c("default", "logit", "cauchit", "probit", "cloglog"), 
                    pdf = "0inflated"
                ), 
                ...
                "0binomial" = list(
                    ...
                    survival = FALSE,
                    discrete = TRUE,
                    link = c("default", "logit", "loga", "cauchit", "probit", "cloglog", "loglog", "log"), 
                    link.simple = c("default", "logit", "cauchit", "probit", "cloglog"), 
                    pdf = "0inflated"
                ), 
