            ...
            list(
                 models=list(
                         ...
                         generic2 = list(ntheta = 2, theta = c("precision-cmatrix", "h2"), nparameters = 4, npriors =2,
                                 ...
                                 n.div.by = NULL, n.required = TRUE, set.default.values = TRUE),
                         sphere = list(ntheta = 4, theta = c("theta.T", "theta.K", "theta.TK", "theta.A"), nparameters = 8, npriors = 4,
                                 constr = FALSE, nrow.ncol = FALSE, augmented = FALSE, aug.factor = 1, aug.constr = NULL,
                                 n.div.by = NULL, n.required = FALSE, set.default.values = FALSE),
                         ...
                         "2diidwishart" = list(ntheta = 3, theta = c("precision1", "precision2", "correlation"),
                                 nparameters = 4, npriors = 1, constr = FALSE, nrow.ncol = FALSE, augmented = FALSE,
                                 aug.factor = 1, aug.constr = NULL, n.div.by = NULL, n.required = FALSE, set.default.values = FALSE),
                         "2diidwishartpart0" = list(ntheta = 3, theta = c("precision1", "precision2", "correlation"),
                                 nparameters = 4, npriors = 1, constr = FALSE, nrow.ncol = FALSE, augmented = FALSE,
                                 aug.factor = 1, aug.constr = NULL, n.div.by = NULL, n.required = FALSE, set.default.values = FALSE),
                         "2diidwishartp1" = list(ntheta = 3, theta = c("precision1", "precision2", "correlation"),
                                 nparameters = 4, npriors = 1, constr = FALSE, nrow.ncol = FALSE, augmented = FALSE,
                                 aug.factor = 1, aug.constr = NULL, n.div.by = NULL, n.required = FALSE, set.default.values = FALSE),
                         "2diidwishartpart1" = list(ntheta = 0, theta = NULL, nparameters = 0, npriors = 0,
                                 constr = FALSE, nrow.ncol = FALSE, augmented = FALSE, aug.factor = 1, aug.constr = NULL,
                                 n.div.by = NULL, n.required = FALSE, set.default.values = FALSE),
                         "2diidwishartp2" = list(ntheta = 0, theta = NULL, nparameters = 0, npriors = 0,
                                 constr = FALSE, nrow.ncol = FALSE, augmented = FALSE, aug.factor = 1, aug.constr = NULL,
                                 n.div.by = NULL, n.required = FALSE, set.default.values = FALSE),
                         "3diidwishart" = list(ntheta = 6,
                                 theta = c("precision1", "precision2", "precision3", "correlation12", "correlation13", "correlation23"),
                                 nparameters = 7, npriors = 1, constr = FALSE, nrow.ncol = FALSE, augmented = TRUE,
                                 aug.factor = 3, aug.constr = c(1,2,3), n.div.by = NULL, n.required = FALSE, set.default.values = FALSE),
                         "3diidwishartpart0" = list(ntheta = 6,
                                 theta = c("precision1", "precision2", "precision3", "correlation12", "correlation13", "correlation23"),
                                 nparameters = 7, npriors = 1, constr = FALSE, nrow.ncol = FALSE, augmented = FALSE,
                                 aug.factor = 1, aug.constr = NULL, n.div.by = NULL, n.required = FALSE, set.default.values = FALSE),
                         "3diidwishartp1" = list(ntheta = 6,
                                 theta = c("precision1", "precision2", "precision3", "correlation12", "correlation13", "correlation23"),
                                 nparameters = 7, npriors = 1, constr = FALSE, nrow.ncol = FALSE, augmented = FALSE,
                                 aug.factor = 1, aug.constr = NULL, n.div.by = NULL, n.required = FALSE, set.default.values = FALSE),
                         "3diidwishartpart1" = list(ntheta = 0, theta = NULL, nparameters = 0, npriors = 0,
                                 constr = FALSE, nrow.ncol = FALSE, augmented = FALSE, aug.factor = 1, aug.constr = NULL,
                                 n.div.by = NULL, n.required = FALSE, set.default.values = FALSE),
                         "3diidwishartp2" = list(ntheta = 0, theta = NULL, nparameters = 0, npriors = 0,
                                 constr = FALSE, nrow.ncol = FALSE, augmented = FALSE, aug.factor = 1, aug.constr = NULL,
                                 n.div.by = NULL, n.required = FALSE, set.default.values = FALSE),
                         "3diidwishartpart2" = list(ntheta = 0, theta = NULL, nparameters = 0, npriors = 0,
                                 constr = FALSE, nrow.ncol = FALSE, augmented = FALSE, aug.factor = 1, aug.constr = NULL,
                                 n.div.by = NULL, n.required = FALSE, set.default.values = FALSE),
                         "3diidwishartp3" = list(ntheta = 0, theta = NULL, nparameters = 0, npriors = 0,
                                 constr = FALSE, nrow.ncol = FALSE, augmented = FALSE, aug.factor = 1, aug.constr = NULL,
                                 n.div.by = NULL, n.required = FALSE, set.default.values = FALSE),
                         "3diidwishartpart3" = list(ntheta = 0, theta = NULL, nparameters = 0, npriors = 0,
                                 constr = FALSE, nrow.ncol = FALSE, augmented = FALSE, aug.factor = 1, aug.constr = NULL,
                                 n.div.by = NULL, n.required = FALSE, set.default.values = FALSE),
