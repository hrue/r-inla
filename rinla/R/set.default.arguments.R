...
#' @title control.taucs
#' @inherit control.update params description seealso
#' @details Extra options controlling the TAUCS library
#' @family control
#' @export
`control.taucs` <-
    function(
             #' @param block.size Minimum number of rhs's in one block
             block.size = 8
             ) {
...
#' @rdname control.taucs
#' @export
`inla.set.control.taucs.default` <- function(...) { control.taucs(...) }
