    ...
    function(...)
{
    ...
    ##:NAME: control.group
    list(
        ##:ARGUMENT: model Group model (one of 'exchangable', 'ar1',  'ar', 'rw1', 'rw2', 'besag', or 'I')
        model = "exchangeable",
    ...
    function(...)
{
    ...
    ans = list(
        ...
        ##:ARGUMENT: correct.factor Factor used in adjusting the correction factor (default=10) if correct=TRUE
        correct.factor = 10.0,
