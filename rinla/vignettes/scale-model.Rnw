...
<<fig.keep='high',echo=FALSE,eval=TRUE>>= %chunk 14
...
\makebox[\MyFigureSpacing][c]{}
\makebox[0.28\textwidth][c]{
<<fig.keep='high',echo=FALSE,eval=TRUE>>= %chunk 15
matplot(x2,mat2,type="lll",lty=c(1,2,4),col=c(1,4,2),xlab="x",ylab="f(x)",ylim=r,lwd=3)
@
}
\makebox[\MyFigureSpacing][c]{}
\makebox[0.28\textwidth][c]{
<<fig.keep='high',echo=FALSE,eval=TRUE>>= %chunk 16
...
\mbox{
\makebox[0.45\textwidth][c]{
<<fig.keep='high',echo=FALSE,eval=TRUE>>= %chunk 22
...
\makebox[\MyFigureSpacing][c]{}
\makebox[0.45\textwidth][c]{
<<fig.keep='high',echo=FALSE,eval=TRUE>>= %chunk 23
...
\mbox{
\makebox[0.45\textwidth][c]{
<<fig.keep='high',echo=FALSE,eval=TRUE>>= %chunk 25
...
\makebox[\MyFigureSpacing][c]{}
\makebox[0.45\textwidth][c]{
<<fig.keep='high',echo=FALSE,eval=TRUE>>= %chunk 26
