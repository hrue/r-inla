...
We do no consider it and just play with the text and its structure directly:
<<read>>=
...
<<nugget, mar3311=TRUE, fig.width=5, fig.height=5, out.width='0.35\\textwidth', fig.align='center', fig.pos='h'>>=
