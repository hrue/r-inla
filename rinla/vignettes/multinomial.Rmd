...
![Confidence Interval for beta varying the size parameter N](img/beta.confidence.jpeg){width=500px}

![Confidence Interval for the difference between gamma.B and gamma.A varying the size parameter N](img/diff.confidence.jpeg){height=350px}
...
![Boxplot of the estimated random effect mean square errors varying the size parameter N](img/MSE.iid.jpeg){width=350px}
...
![Confidence intervals for a sample of 20 points from the random effect varying the size parameter N](img/conf.iid.jpeg){width=485px}
